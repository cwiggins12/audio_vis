...
![standard spectrum analyser](docs/gifs/basic_analyser.gif)

![mel spectrogram](docs/gifs/mel_spec.gif)

![center pulsing abstract shader](docs/gifs/center_pulse.gif)
